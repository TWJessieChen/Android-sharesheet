...
object GenerateBriteMedXMLMethod {
    ...
    fun generateBriteMEDXMLFile(filePath: String, fileName: String) {
        ...
        try {
            ...
            xs.text("Rhythm: sinusrhythm. with bradycardia. ")
            xs.endTag(null, "value")
            changeLine(xs, enter)
            ...
            ///////////////////////////// </derivation> /////////////////////////////////////////
            xs.startTag(null, "derivation") // <derivation>
            changeLine(xs, enter)
            xs.startTag(null, "derivedSeries") // <derivedSeries>
            changeLine(xs, enter)
            xs.startTag(null, "id") // <id root="ad53f3c4-0218-49a7-8142-3a2612c94222"/>
            xs.attribute(null,"root", "ad53f3c4-0218-49a7-8142-3a2612c94222")
            xs.endTag(null, "id")
            changeLine(xs, enter)
            xs.startTag(null, "code") // <code code="REPRESENTATIVE_BEAT" codeSystem="2.16.840.1.113883.5.4" codeSystemName="ActCode" displayName="Representative Beat Waveforms"/>
            xs.attribute(null,"code", "REPRESENTATIVE_BEAT")
            xs.attribute(null,"codeSystem", "2.16.840.1.113883.5.4")
            xs.attribute(null,"codeSystemName", "ActCode")
            xs.attribute(null,"displayName", "Representative Beat Waveforms")
            xs.endTag(null, "code")
            changeLine(xs, enter)
            ///////////////////////////// <effectiveTime> /////////////////////////////////////////
            xs.startTag(null, "effectiveTime") // <effectiveTime>
            ...
            for(index in 0 until 3) {
                ...
                xs.startTag(null, "annotation") // <annotation>
                changeLine(xs, enter)
                xs.startTag(null, "code") // <code code="MDC_ECG_WAVC" codeSystem="2.16.840.1.113883.6.24"/>
                xs.attribute(null,"code", "MDC_ECG_WAVC")
                xs.attribute(null,"codeSystem", "2.16.840.1.113883.6.24")
                xs.endTag(null, "code")
                changeLine(xs, enter)
                ...
                when(index) {
                    0 -> {
                        xs.startTag(null, "value") // <value xsi:type="CE" code="MDC_ECG_WAVC_PWAVE" codeSystem="2.16.840.1.113883.6.24"/>
                        xs.attribute(null,"xsi:type", "CE")
                        xs.attribute(null,"code", "MDC_ECG_WAVC_PWAVE")
                        xs.attribute(null,"codeSystem", "2.16.840.1.113883.6.24")
                        xs.endTag(null, "value")
                        changeLine(xs, enter)
                    }
                    1 -> {
                        xs.startTag(null, "value") // <value xsi:type="CE" code="MDC_ECG_WAVC_QRSWAVE" codeSystem="2.16.840.1.113883.6.24"/>
                        xs.attribute(null,"xsi:type", "CE")
                        xs.attribute(null,"code", "MDC_ECG_WAVC_QRSWAVE")
                        xs.attribute(null,"codeSystem", "2.16.840.1.113883.6.24")
                        xs.endTag(null, "value")
                        changeLine(xs, enter)
                    }
                    2 -> {
                        xs.startTag(null, "value") // <value xsi:type="CE" code="MDC_ECG_WAVC_TWAVE" codeSystem="2.16.840.1.113883.6.24"/>
                        xs.attribute(null,"xsi:type", "CE")
                        xs.attribute(null,"code", "MDC_ECG_WAVC_TWAVE")
                        xs.attribute(null,"codeSystem", "2.16.840.1.113883.6.24")
                        xs.endTag(null, "value")
                        changeLine(xs, enter)
                    }
                }
                xs.startTag(null, "support") // <support>
                changeLine(xs, enter)
                xs.startTag(null, "supportingROI") // <supportingROI>
                changeLine(xs, enter)
                xs.startTag(null, "code") // <code code="ROIPS" codeSystem="2.16.840.1.113883.5.4" codeSystemName="HL7V3"/>
                xs.attribute(null,"code", "ROIPS")
                xs.attribute(null,"codeSystem", "2.16.840.1.113883.5.4")
                xs.attribute(null,"codeSystemName", "HL7V3")
                xs.endTag(null, "code")
                changeLine(xs, enter)
                xs.startTag(null, "component") // <component>
                changeLine(xs, enter)
                xs.startTag(null, "boundary") // <boundary>
                changeLine(xs, enter)
                xs.startTag(null, "code") // <code code="TIME_RELATIVE" codeSystem="2.16.840.1.113883.6.24"/>
                xs.attribute(null,"code", "TIME_RELATIVE")
                xs.attribute(null,"codeSystem", "2.16.840.1.113883.6.24")
                xs.endTag(null, "code")
                changeLine(xs, enter)
                when(index) {
                    0 -> {
                        xs.startTag(null, "value") // <value xsi:type="IVL_PQ">
                        xs.attribute(null,"xsi:type", "IVL_PQ")
                        changeLine(xs, enter)
                        xs.startTag(null, "low") // <low value="0" unit="ms"/>
                        xs.attribute(null,"value", "0")
                        xs.attribute(null,"unit", "ms")
                        xs.endTag(null, "low")
                        changeLine(xs, enter)
                        xs.startTag(null, "high") // <high value="116" unit="ms"/>
                        xs.attribute(null,"value", "116") /**JC666 這裡(116)需要拿病患ECG report q_dur欄位的值!!!*/
                        xs.attribute(null,"unit", "ms")
                        xs.endTag(null, "high")
                        changeLine(xs, enter)
                        xs.endTag(null, "value")
                    ...
                    1 -> {
                        ...
                        xs.attribute(null,"xsi:type", "IVL_PQ")
                        changeLine(xs, enter)
                        xs.startTag(null, "low") // <low value="178" unit="ms"/>
                        xs.attribute(null,"value", "178") /**JC666 這裡(178)需要拿病患ECG report pr_int欄位的值!!!*/
                        xs.attribute(null,"unit", "ms")
                        xs.endTag(null, "low")
                        changeLine(xs, enter)
                        xs.startTag(null, "high") // <high value="278" unit="ms"/>
                        xs.attribute(null,"value", "278") /**JC666 這裡(278)需要拿病患ECG report qrs_dur + pr_int 欄位加總的值!!!*/
                        xs.attribute(null,"unit", "ms")
                        xs.endTag(null, "high")
                        changeLine(xs, enter)
                        xs.endTag(null, "value")
                    ...
                    2 -> {
                        ...
                        xs.attribute(null,"xsi:type", "IVL_PQ")
                        changeLine(xs, enter)
                        xs.startTag(null, "high") // <high value="566" unit="ms"/>
                        xs.attribute(null,"value", "566") /**JC666 這裡(566)需要拿病患ECG report qt_int + pr_int 欄位加總的值!!!*/
                        xs.attribute(null,"unit", "ms")
                        xs.endTag(null, "high")
                        changeLine(xs, enter)
                        xs.endTag(null, "value")
                ...
                xs.endTag(null, "boundary") // </boundary>
                changeLine(xs, enter)
                xs.endTag(null, "component") // </component>
                changeLine(xs, enter)
                xs.endTag(null, "supportingROI") // </supportingROI>
                changeLine(xs, enter)
                xs.endTag(null, "support") // </support>
                changeLine(xs, enter)
                xs.endTag(null, "annotation") // </annotation>
                changeLine(xs, enter)
                xs.endTag(null, "component") // </component>
            ...
            for(index in 0 until 3) {
                xs.startTag(null, "component") // <annotation>
                changeLine(xs, enter)
                xs.startTag(null, "annotation") // <annotation>
                changeLine(xs, enter)
                ...
                when(index) {
                    0 -> {
                        xs.startTag(null, "code") // <code code="MDC_ECG_ANGLE_P_FRONT" codeSystem="2.16.840.1.113883.6.24"/>
                        xs.attribute(null,"code", "MDC_ECG_ANGLE_P_FRONT")
                        xs.attribute(null,"codeSystem", "2.16.840.1.113883.6.24")
                        xs.endTag(null, "code")
                        changeLine(xs, enter)
                        xs.startTag(null, "value") // <value xsi:type="PQ" value= "26" unit="deg"/>
                        xs.attribute(null,"xsi:type", "PQ")
                        xs.attribute(null,"value", "26") /**JC666 這裡(26)需要拿病患ECG report p_axis欄位加總的值!!!*/
                        xs.attribute(null,"unit", "deg")
                        xs.endTag(null, "value")
                        changeLine(xs, enter)
                    }
                    1 -> {
                        xs.startTag(null, "code") // <code code="MDC_ECG_ANGLE_QRS_FRONT" codeSystem="2.16.840.1.113883.6.24"/>
                        xs.attribute(null,"code", "MDC_ECG_ANGLE_QRS_FRONT")
                        xs.attribute(null,"codeSystem", "2.16.840.1.113883.6.24")
                        xs.endTag(null, "code")
                        changeLine(xs, enter)
                        xs.startTag(null, "value") // <value xsi:type="PQ" value="150" unit="deg"/>
                        xs.attribute(null,"xsi:type", "PQ")
                        xs.attribute(null,"value", "150") /**JC666 這裡(150)需要拿病患ECG report qrs_axis欄位加總的值!!!*/
                        xs.attribute(null,"unit", "deg")
                        xs.endTag(null, "value")
                        changeLine(xs, enter)
                    }
                    2 -> {
                        xs.startTag(null, "code") // <code code="MDC_ECG_ANGLE_T_FRONT" codeSystem= "2.16.840.1.113883.6.24"/>
                        xs.attribute(null,"code", "MDC_ECG_ANGLE_T_FRONT")
                        xs.attribute(null,"codeSystem", "2.16.840.1.113883.6.24")
                        xs.endTag(null, "code")
                        changeLine(xs, enter)
                        xs.startTag(null, "value") // <value xsi:type="PQ" value="27" unit="deg"/>
                        xs.attribute(null,"xsi:type", "PQ")
                        xs.attribute(null,"value", "27") /**JC666 這裡(27)需要拿病患ECG report t_axis欄位加總的值!!!*/
                        xs.attribute(null,"unit", "deg")
                        xs.endTag(null, "value")
                        changeLine(xs, enter)
                    }
                ...
                xs.endTag(null, "annotation") // </annotation>
                changeLine(xs, enter)
                xs.endTag(null, "component") // </annotation>
                changeLine(xs, enter)
            }
            xs.endTag(null, "annotationSet") // </annotationSet>
            changeLine(xs, enter)
            ...
            xs.endTag(null, "derivedSeries") // </derivedSeries>
            changeLine(xs, enter)
            xs.endTag(null, "derivation") // </derivation>
            changeLine(xs, enter)
            ///////////////////////////// </derivation> /////////////////////////////////////////
